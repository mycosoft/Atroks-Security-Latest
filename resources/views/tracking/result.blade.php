...
@section('content')
    ...
    <section class="py-20 bg-gray-50" data-reveal>
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-28 relative z-20">
            <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12 border border-gray-100" data-reveal data-delay="100">
                ...
                <!-- Result Header -->
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10 pb-8 border-b border-gray-200" data-reveal data-delay="150">
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    <!-- Client Information -->
                    <div class="bg-gray-50 p-6 rounded-xl border border-gray-200" data-reveal data-delay="200">
                    ...
                    <!-- Package Details -->
                    <div class="bg-gray-50 p-6 rounded-xl border border-gray-200" data-reveal data-delay="300">
                        <div class="flex items-center gap-3 mb-4">
                ...
                <div class="mb-12" data-reveal>
                    <h3 class="text-2xl font-bold text-navy mb-8 text-center" data-reveal data-delay="100">Package Journey</h3>
                    <div class="relative">
                        <!-- Timeline line -->
                ...
                <!-- Action Buttons -->
                <div class="flex flex-col sm:flex-row gap-4 justify-center pt-8 border-t border-gray-200" data-reveal data-delay="150">
    ...
    <!-- Info Section -->
    <section class="py-16 bg-navy" data-reveal>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center text-white mb-12" data-reveal data-delay="100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white/10 backdrop-blur-sm p-8 rounded-2xl text-center hover:bg-white/20 transition" data-reveal data-delay="150">
                ...
                <div class="bg-white/10 backdrop-blur-sm p-8 rounded-2xl text-center hover:bg-white/20 transition" data-reveal data-delay="250">
                    <div class="bg-orange/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <div class="bg-white/10 backdrop-blur-sm p-8 rounded-2xl text-center hover:bg-white/20 transition" data-reveal data-delay="350">
                    <div class="bg-orange/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
