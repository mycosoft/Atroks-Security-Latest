...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-28 relative z-20">
            <div class="bg-white rounded-xl shadow-2xl p-8 md:p-12 border border-gray-100">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="relative h-96 rounded-xl overflow-hidden shadow-lg group">
    ...
    <section class="py-20 bg-navy">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <!-- Mission -->
                <div class="bg-white rounded-xl p-8 border-l-4 border-orange hover:shadow-lg transition duration-300">
    ...
    <section class="py-20 bg-gray-50 border-t border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl font-bold text-navy mb-12">Our Core Values</h2>
