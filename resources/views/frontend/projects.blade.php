...
@section('content')
    ...
    <section class="py-20 bg-gray-50" data-reveal>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-28 relative z-20">
            ...
            <div class="mb-12 text-center" data-reveal data-delay="100">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <!-- Project 1 -->
                <div class="bg-white rounded-xl shadow-lg overflow-hidden group hover:shadow-2xl transition duration-300" data-reveal data-delay="150">
                ...
                <!-- Project 2 -->
                <div class="bg-white rounded-xl shadow-lg overflow-hidden group hover:shadow-2xl transition duration-300" data-reveal data-delay="250">
                    <div class="h-64 overflow-hidden relative">
                ...
                <!-- Project 3 -->
                <div class="bg-white rounded-xl shadow-lg overflow-hidden group hover:shadow-2xl transition duration-300" data-reveal data-delay="350">
                    <div class="h-64 overflow-hidden relative">
                ...
                <!-- Project 4 -->
                <div class="bg-white rounded-xl shadow-lg overflow-hidden group hover:shadow-2xl transition duration-300" data-reveal data-delay="450">
                    <div class="h-64 overflow-hidden relative">
                ...
                <!-- Project 5 -->
                <div class="bg-white rounded-xl shadow-lg overflow-hidden group hover:shadow-2xl transition duration-300" data-reveal data-delay="550">
                    <div class="h-64 overflow-hidden relative">
                 ...
                 <!-- Project 6 -->
                 <div class="bg-white rounded-xl shadow-lg overflow-hidden group hover:shadow-2xl transition duration-300" data-reveal data-delay="650">
                    <div class="h-64 overflow-hidden relative">
    ...
    <!-- Call to Action -->
    <section class="bg-navy py-16" data-reveal>
